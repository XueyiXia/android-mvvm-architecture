...
import com.jetpack.mvvm.model.HistoryProvider.Range.Companion.FIVE_YEARS
import com.jetpack.mvvm.model.HistoryProvider.Range.Companion.MAX
import com.jetpack.mvvm.model.HistoryProvider.Range.Companion.ONE_DAY
import com.jetpack.mvvm.model.HistoryProvider.Range.Companion.ONE_MONTH
import com.jetpack.mvvm.model.HistoryProvider.Range.Companion.ONE_YEAR
import com.jetpack.mvvm.model.HistoryProvider.Range.Companion.THREE_MONTH
import com.jetpack.mvvm.model.HistoryProvider.Range.Companion.TWO_WEEKS
import com.jetpack.mvvm.network.ChartApi
import com.jetpack.mvvm.network.data.DataPoint
...
class HistoryProvider @Inject constructor(
  ...
  suspend fun fetchDataShort(symbol: String): FetchResult<List<DataPoint>> = withContext(Dispatchers.IO) {
    ...
    return@withContext FetchResult.Companion.success(dataPoints)
  }
